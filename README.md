...
Odpowiedź:  Dioda w symulatorze płytki świeci cały czas.

## Zadanie 2-2-2:
Pytanie:    *Czy zamienienie kolejności podłączenia diody LED i rezystora ma znaczenie?*  
Odpowiedź:  Nie ma znaczenia, dioda miga w obu przypadkach.

## Zadanie 2-2-3:
Pytanie:    *Czy każdy rodzaj pętli jest wymienny (zawsze można zastąpić jedną konstrukcję drugą)?*  
Odpowiedź:  Nie każdy rodzaj pętli jest wymienny, pętle for można zastąpić pętlą while. Najeży zwracać uwage na pętle do while, która zawsze wykona sie przynajmniej raz. 
...
Odpowiedź:  Jest krótki czas trwania sygnału zielonego (zielona dioda).
